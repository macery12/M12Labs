...
class Server extends Model
{
    ...
    protected $casts = [
        ...
        'installed_modpack_id' => 'integer',
        'installed_modpack_name' => 'string',
        'installed_modpack_version' => 'string',
        'installed_modpack_file_id' => 'integer',
        'installed_modpack_files' => 'array',
