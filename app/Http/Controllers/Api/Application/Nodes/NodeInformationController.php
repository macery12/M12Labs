...
use Everest\Http\Requests\Api\Application\Nodes\NodeInformationRequest;
...
class NodeInformationController extends ApplicationApiController
{
     ...
     */
    public function information(NodeInformationRequest $request, Node $node): JsonResponse
    {
     ...
     * @throws \Everest\Exceptions\Http\Connection\DaemonConnectionException
     */
    public function utilization(NodeInformationRequest $request, Node $node): JsonResponse
    {
