    ...
    return (
            ...
            right={
                config ? (
                    ...
                    >
                        ...
                        {copied ? t('nodes.configTab.copied') : t('nodes.configTab.copy')}
                    </button>
                ) : undefined
            }
            flush
        >
            {isLoading ? (
                ...
                <p className="p-4 text-sm text-[var(--color-ink-faint)]">{t('nodes.configTab.loadError')}</p>
            ) : (
