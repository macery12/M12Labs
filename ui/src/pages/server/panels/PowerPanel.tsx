...
export function PowerPanel() {
    ...
    return (
        <Panel title={t('power.title')} icon={Power}>
            <div className="flex flex-col gap-2">
                ...
                >
                    <Play className="h-3.5 w-3.5" /> {t('common:power.start')}
                </button>
                <div className="grid grid-cols-2 gap-2">
                    ...
                    >
                        <RotateCcw className="h-3.5 w-3.5" /> {t('common:power.restart')}
                    </button>
                    <button
                        onClick={() => send('stop')}
                        disabled={!ready || isOffline}
                    ...
                    >
                        <Square className="h-3.5 w-3.5" /> {t('common:power.stop')}
                    </button>
                </div>
                <button
                    onClick={() => {
                ...
                >
                    <Zap className="h-3.5 w-3.5" /> {confirmKill ? t('power.confirmKill') : t('power.forceKill')}
                </button>
            </div>
        </Panel>
    );
