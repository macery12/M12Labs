    ...
    return (
        <div>
            ...
            <Alert type={'info'} className={'mb-4'}>
                <strong>Global Billing Settings:</strong> These settings apply to all products. The multiplier steps control pricing for different billing cycle lengths across all products. The billing cycle system has replaced the old renewal and grace period settings.
            </Alert>
