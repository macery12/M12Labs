...
const EmailContainer = lazy(() => import('@/components/admin/modules/email/EmailContainer'));
...
const admin: AdminRouteDefinition[] = [
    ...
    route('email', EmailContainer, { name: 'Email', icon: Icon.MailIcon, category: 'modules', advanced: true }),
