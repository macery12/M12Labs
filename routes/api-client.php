    ...
    */
    Route::group([
        ...
        Route::group(['prefix' => '/mods'], function () {
            // Server introspection (detected MC version / loader / platform), not
            // a marketplace surface: the AI extension's diagnostics read it too,
            // so it stays reachable with the marketplace switched off. Declared
            // first so the gated /{modId} wildcard below cannot swallow it.
            ...
            Route::middleware('marketplace')->group(function () {
                ...
                Route::prefix('/modpacks')->middleware('marketplace:modpacks')->group(function () {
